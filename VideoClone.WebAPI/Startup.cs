...
//        });
//
//        services.AddDbContext<VideoCloneContext>(options =>
//        {
//            var connectionStr = Configuration.GetConnectionString("VideoClone");
...
//            app.UseSwagger();
//            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "VideoClone.WebAPI v1"));
//        }
//
